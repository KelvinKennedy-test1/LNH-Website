...
var dpBookAppointment = document.getElementById('dpBookAppointment');
...
/* ══════════════════════════════════════════
   ── NAV LINKS → HIGHLIGHT TARGET CARD ──
══════════════════════════════════════════ */
...
// Support direct links / page-load hashes pointing at a highlightable card
window.addEventListener('DOMContentLoaded', function () {
    var hash = window.location.hash.slice(1);
    if (hash && document.getElementById(hash) &&
        document.getElementById(hash).matches('.service-card, .team-card, .info-card, .ins-pill')) {
